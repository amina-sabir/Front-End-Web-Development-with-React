...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavbarToggler, Collapse, NavItem, Modal, ModalHeader,ModalBody, Form, FormGroup, Input, Button, Label } from 'reactstrap';
        ...
        return(
            ...
            <Navbar dark expand="md">
                ...
                <NavbarBrand className="mr-auto" href="/">
                    <img src='assets/images/logo.png' heigh='30' width='41' alt='Ristorante Con Fusion' />
                </NavbarBrand>
                ...
                <Nav navbar>
                    ...
                    <NavItem>
                        <NavLink className="nav-link" to="/contactus"><span className="fa fa-address-card fa-lg"> Conatct Us </span></NavLink>
                    </NavItem>
                </Nav>
